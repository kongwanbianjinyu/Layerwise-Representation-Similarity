...
def parse_config():
    ...
    parser.add_argument("--eval_every", type=int, 
        help="how many update steps to evaluate result")
...
if __name__ == '__main__':
    ...
    if cuda_available:
        ...
        pass
    print ('Model loaded') 
    total_steps, print_every, eval_every, save_every = args.total_steps, args.print_every, args.eval_every, args.save_every
    ckpt_save_path = args.save_path_prefix
    model = model_training(args, data, model, total_steps, print_every, eval_every, save_every, 
